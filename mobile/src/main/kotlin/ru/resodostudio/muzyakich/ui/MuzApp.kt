...
fun MuzApp() {
    Scaffold { padding ->
        Column(
            ...
            val tabs = listOf(
                stringResource(localesR.string.playlists),
                stringResource(localesR.string.songs),
                stringResource(localesR.string.albums),
                stringResource(localesR.string.artists),
            )
